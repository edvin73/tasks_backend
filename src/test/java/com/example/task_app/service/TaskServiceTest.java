...
class TaskServiceTest {
    ...
    @BeforeEach
    void setUp() {
        task1 = new Task(1L, "Title One", "0");
        task2 = new Task(2L, "Title Two", "1");
    }
    ...
    void createTask_savesAndReturns() {
        ...
        Task result = taskService.createTask(new Task(null, "Title One", "NO"));
    ...
    void updateTask_noChanges_doesNotSave() {
        Task incoming = new Task(1L, "Title One", "0");
        when(taskRepository.findById(1L)).thenReturn(Optional.of(task1));
    ...
    void updateTask_withChanges_saves() {
        Task incoming = new Task(1L, "New Title", "0");
        Task saved = new Task(1L, "New Title", "0");
